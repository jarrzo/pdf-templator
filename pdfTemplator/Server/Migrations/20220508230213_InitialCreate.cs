        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conversions_Templates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "Templates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FieldTemplate", x => new { x.FieldsId, x.TemplatesId });
                    table.ForeignKey(
                        name: "FK_FieldTemplate_Fields_FieldsId",
                        column: x => x.FieldsId,
                        principalTable: "Fields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FieldTemplate_Templates_TemplatesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversions_TemplateId",
                table: "Conversions",
                column: "TemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_FieldTemplate_TemplatesId",
                table: "FieldTemplate",
                column: "TemplatesId");
